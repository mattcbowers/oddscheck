...
def get_data(fname, frac_na_tolerable = 0.05):
    ...
    col_initial_keep = ['funding_status', 'school_zip', 'school_metro', 'school_charter', 'school_magnet', 'school_year_round', 'school_nlns', 'school_kipp', 'school_charter_ready_promise', 'teacher_prefix', 'teacher_teach_for_america', 'teacher_ny_teaching_fellow', 'primary_focus_area', 'secondary_focus_area', 'resource_type', 'poverty_level', 'grade_level', 'total_price_excluding_optional_support', 'students_reached']
    ...
    cols_to_keep = list(frac_na.loc[frac_na < frac_na_tolerable * frac_na.shape[0]].index)
    df = df[cols_to_keep]
