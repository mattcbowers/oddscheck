...
total_exp_num_funded = df.p_hat.sum()
total_exp_num_funded_oc = df.p_hat_oc.sum()

print()
print('For projects that get an OddsCheck reccommendation')
...
print(total_exp_payoff_oc - total_exp_payoff)
print()
print('Total expected number of funded projects')
print(total_exp_num_funded)
print('Total expected number of funded projects under OC')
print(total_exp_num_funded_oc)
